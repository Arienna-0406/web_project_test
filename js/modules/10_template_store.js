...
const TemplateStore = {
  ...
  getEffectJS(effects) {
    ...
    effects.forEach(function(eid) {
      if (eid === 'none') return;
      var fxMap = {
        'snow': 'var _sfSnow=document.createElement("div");_sfSnow.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfSnow);(function(){for(var i=0;i<15;i++){var f=document.createElement("div");f.style.cssText="position:absolute;color:#fff;font-size:"+(8+Math.random()*10)+"px;top:-20px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfSnowFall "+(8+Math.random()*10)+"s linear infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0.4";f.textContent="❄";_sfSnow.appendChild(f)}var st=document.createElement("style");st.textContent="@keyframes sfSnowFall{0%{transform:translateY(-20px) rotate(0deg)}100%{transform:translateY(105vh) rotate(360deg)}}";document.head.appendChild(st)})();',
        'sparkle': 'var _sfSp=document.createElement("div");_sfSp.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfSp);(function(){for(var i=0;i<10;i++){var s=document.createElement("div");s.style.cssText="position:absolute;color:#ffd700;font-size:"+(10+Math.random()*14)+"px;top:"+Math.random()*100+"%;left:"+Math.random()*100+"%;animation:sfSparkle "+(4+Math.random()*6)+"s ease-in-out infinite alternate;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0";s.textContent="✨";_sfSp.appendChild(s)}var st=document.createElement("style");st.textContent="@keyframes sfSparkle{0%{opacity:0;transform:scale(0.5) rotate(0deg)}100%{opacity:0.4;transform:scale(1.1) rotate(180deg)}}";document.head.appendChild(st)})();',
        'bubbles': 'var _sfBub=document.createElement("div");_sfBub.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfBub);(function(){for(var i=0;i<8;i++){var b=document.createElement("div");var sz=12+Math.random()*16;b.style.cssText="position:absolute;width:"+sz+"px;height:"+sz+"px;border-radius:50%;background:radial-gradient(circle at 30% 30%,rgba(255,255,255,0.8),rgba(173,216,230,0.5));bottom:-30px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfBubble "+(10+Math.random()*12)+"s ease-in infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;border:1px solid rgba(255,255,255,0.5)";_sfBub.appendChild(b)}var st=document.createElement("style");st.textContent="@keyframes sfBubble{0%{transform:translateY(0) scale(1);opacity:0.8}100%{transform:translateY(-110vh) scale(0.4);opacity:0}}";document.head.appendChild(st)})();',

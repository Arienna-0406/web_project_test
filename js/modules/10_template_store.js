...
const TemplateStore = {
  ...
  getEffectJS(effects) {
    ...
    effects.forEach(function(eid) {
      if (eid === 'none') return;
      var fxMap = {
        'snow': 'var _sfSnow=document.createElement("div");_sfSnow.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfSnow);(function(){for(var i=0;i<30;i++){var f=document.createElement("div");f.style.cssText="position:absolute;color:#ffffff;font-size:"+(8+Math.random()*10)+"px;top:-20px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfSnowFall "+(8+Math.random()*10)+"s linear infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0.4";f.textContent="❄";_sfSnow.appendChild(f)}var st=document.createElement("style");st.textContent="@keyframes sfSnowFall{0%{transform:translateY(-20px) rotate(0deg)}100%{transform:translateY(105vh) rotate(360deg)}}";document.head.appendChild(st)})();',
        'sparkle': 'var _sfSp=document.createElement("div");_sfSp.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfSp);(function(){for(var i=0;i<20;i++){var s=document.createElement("div");s.style.cssText="position:absolute;color:#ffeaa7;font-size:"+(10+Math.random()*14)+"px;top:"+Math.random()*100+"%;left:"+Math.random()*100+"%;animation:sfSparkle "+(4+Math.random()*6)+"s ease-in-out infinite alternate;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0";s.textContent="✨";_sfSp.appendChild(s)}var st=document.createElement("style");st.textContent="@keyframes sfSparkle{0%{opacity:0;transform:scale(0.5) rotate(0deg)}100%{opacity:0.4;transform:scale(1.1) rotate(180deg)}}";document.head.appendChild(st)})();',
        'bubbles': 'var _sfBub=document.createElement("div");_sfBub.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfBub);(function(){for(var i=0;i<16;i++){var b=document.createElement("div");var sz=12+Math.random()*16;b.style.cssText="position:absolute;width:"+sz+"px;height:"+sz+"px;border-radius:50%;background:radial-gradient(circle at 30% 30%,rgba(255,255,255,0.8),rgba(173,216,230,0.5));bottom:-30px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfBubble "+(10+Math.random()*12)+"s ease-in infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;border:1px solid rgba(255,255,255,0.5)";_sfBub.appendChild(b)}var st=document.createElement("style");st.textContent="@keyframes sfBubble{0%{transform:translateY(0) scale(1);opacity:0.8}100%{transform:translateY(-110vh) scale(0.4);opacity:0}}";document.head.appendChild(st)})();',
        'hearts': 'var _sfHrt=document.createElement("div");_sfHrt.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfHrt);(function(){for(var i=0;i<8;i++){var h=document.createElement("div");h.style.cssText="position:absolute;font-size:"+(14+Math.random()*10)+"px;top:-30px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfHeart "+(8+Math.random()*10)+"s linear infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0.4";h.textContent=["💕","❤️","💖","💗","💘"][Math.floor(Math.random()*5)];_sfHrt.appendChild(h)}var st=document.createElement("style");st.textContent="@keyframes sfHeart{0%{transform:translateY(-20px) rotate(0deg) scale(1)}50%{transform:translateY(50vh) rotate(15deg) scale(1.1)}100%{transform:translateY(105vh) rotate(-15deg) scale(0.6)}}";document.head.appendChild(st)})();',
        'cherry': 'var _sfCh=document.createElement("div");_sfCh.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfCh);(function(){for(var i=0;i<12;i++){var c=document.createElement("div");c.style.cssText="position:absolute;font-size:"+(12+Math.random()*12)+"px;top:-25px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfCherry "+(10+Math.random()*12)+"s ease-in-out infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0.4";c.textContent=["🌸","✿","❀","🏵️"][Math.floor(Math.random()*4)];_sfCh.appendChild(c)}var st=document.createElement("style");st.textContent="@keyframes sfCherry{0%{transform:translateY(-20px) translateX(0) rotate(0deg)}25%{transform:translateY(25vh) translateX(30px) rotate(90deg)}50%{transform:translateY(50vh) translateX(-20px) rotate(180deg)}75%{transform:translateY(75vh) translateX(25px) rotate(270deg)}100%{transform:translateY(105vh) translateX(0) rotate(360deg)}}";document.head.appendChild(st)})();',
        'music': 'var _sfMus=document.createElement("div");_sfMus.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:7998;overflow:hidden";document.body.appendChild(_sfMus);(function(){for(var i=0;i<6;i++){var m=document.createElement("div");m.style.cssText="position:absolute;font-size:"+(16+Math.random()*12)+"px;bottom:-30px;left:"+Math.random()*100+"%;margin-left:"+((Math.random()-0.5)*100).toFixed(0)+"px;animation:sfMusic "+(7+Math.random()*9)+"s ease-out infinite;animation-delay:"+(Math.random()*25).toFixed(1)+"s;opacity:0";m.textContent=["🎵","🎶","🎼","♪"][Math.floor(Math.random()*4)];_sfMus.appendChild(m)}var st=document.createElement("style");st.textContent="@keyframes sfMusic{0%{transform:translateY(0) rotate(0deg);opacity:0}10%{opacity:0.4}90%{opacity:0.15}100%{transform:translateY(-110vh) rotate(360deg);opacity:0}}";document.head.appendChild(st)})();'
      };
